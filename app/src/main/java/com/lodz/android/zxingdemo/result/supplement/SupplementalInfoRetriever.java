...
package com.lodz.android.zxingdemo.result.supplement;
...
/**
 * Superclass of implementations which can asynchronously retrieve more information about a barcode scan.
 */
